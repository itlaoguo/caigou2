        ...
        <t-row class="row-gap" :gutter="[32, 24]">
          ...
          <t-col :span="6">
            <t-form-item :label="t('pages.formBase.company')" name="partyA">
              <t-select v-model="formData.partyA" :style="{ width: '322px' }" class="demo-select-base"
                :placeholder="t('pages.formBase.contractTypePlaceholder')" clearable>
          ...
          <t-col :span="6">
            <t-form-item :label="t('pages.formBase.employee')" name="partyB">
              <t-select v-model="formData.partyB" :style="{ width: '322px' }"
                :placeholder="t('pages.formBase.contractTypePlaceholder')" class="demo-select-base" clearable>
          ...
          <t-col :span="6">
            <t-form-item :label="t('pages.formBase.upload')" name="files">
              <t-upload v-model="formData.files"
                ...
                :tips="t('pages.formBase.uploadTips')" :size-limit="{ size: 60, unit: 'MB' }"
                :format-response="formatResponse" :before-upload="beforeUpload" @fail="handleFail">
