<template>
    <div id="OrderLine" style="width: 100%;height: 100%;"></div>
</template>
...
const ongetExceedSpeedTrend = async (item: any) => {
    ...
    const myChart = echarts.init(document.getElementById("OrderLine"));
    const option = {
        title: {
            text: ''
        },
        ...
        series: [
            {
                ...
                itemStyle: {
                    color: '#32C5FF',
                    borderColor: '#32C5FF',  // 边框颜色与填充色一致
                    borderWidth: 0           // 边框宽度设为0实现纯实心
                },
                areaStyle: {
