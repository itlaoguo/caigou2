<template>
  <t-row :gutter="[16, 16]">
    <t-col v-for="(item, index) in PANE_LIST" :key="item.title" :xs="6" :xl="3">
      <t-card :title="t(item.title)" :bordered="false" :class="{ 'dashboard-item': true }">
        ...
        <template #footer>
          <div class="dashboard-item-bottom">
            <div class="dashboard-item-block">
              ...
              <trend class="dashboard-item-trend" :type="item.upTrend ? 'up' : 'down'"
...
<script lang="ts">
export default {
  name: 'customerStatisticsTopPanel',
};
</script>
...
import { constructInitDashboardDataset } from '../customer/index';
