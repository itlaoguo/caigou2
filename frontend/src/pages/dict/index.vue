      ...
      <t-row>
        <t-col :span="10">
          <t-row :gutter="[24, 24]">
            ...
            <t-col :span="1">
              <t-input v-model="FormData.no" class="form-item-content" placeholder="字典类型" style="width: 100%" />
            </t-col>
            <t-col :span="1">
              <t-select v-model="FormData.status" class="form-item-content" :options="CONTRACT_STATUS_OPTIONS"
                @change="onSubmit" placeholder="字典状态" clearable />
            </t-col>
            <t-col :span="2">
