<template>
  <div :class="layoutCls">
    <t-head-menu :class="menuCls" :theme="menuTheme" expand-type="popup" :value="active">
      <template #logo>
        <span v-if="showLogo" class="header-logo-container" @click="handleNav('/dashboard/homes')">
          <img :src="logo" alt="">
        </span>
...
import logo from '@/assets/caigou-logo-full.png';
